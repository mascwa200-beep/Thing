...
/**
 * Reading a downloaded pack — the Android twin of the desktop `PackArchive`.
 *
 * A hand-written twin rather than a generated mirror, on this repo's convention: mirrors are for
 * `core:telemetry`, and this is platform I/O. The desktop copy is the one that genuinely runs under
 * test, so it is the one to change first and copy from.
 *
