...
import dev.mascwa.pulse.feature.analytics.UsageAnalytics
import dev.mascwa.pulse.feature.analytics.DiagnosticsHelper
...
class AppContainer(private val appContext: Context) {
    ...
    val usageAnalytics: UsageAnalytics by lazy { UsageAnalytics() }
    val diagnosticsHelper: DiagnosticsHelper by lazy { DiagnosticsHelper() }
