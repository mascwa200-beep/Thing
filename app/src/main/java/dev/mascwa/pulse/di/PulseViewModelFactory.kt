        ...
        val vm: ViewModel = when {
            ...
            modelClass.isAssignableFrom(dev.mascwa.pulse.feature.jarvis.JarvisViewModel::class.java) ->
                dev.mascwa.pulse.feature.jarvis.JarvisViewModel(
                    ...
                    c.curiosityEngine, c.approvalGate, c.usageRepository, c.cerebellumStore,
                )
            ...
            modelClass.isAssignableFrom(SettingsViewModel::class.java) ->
                SettingsViewModel(c.settingsRepository, c.notificationScheduler, c.diskCache, c.notifier, c.updateRepository, c.selfCoder, c.usageRepository, c.cerebellumStore)
