...
class PulseViewModelFactory(private val c: AppContainer) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        val vm: ViewModel = when {
            ...
            modelClass.isAssignableFrom(dev.mascwa.pulse.feature.dial.ReactorDialViewModel::class.java) ->
                dev.mascwa.pulse.feature.dial.ReactorDialViewModel(c.applicationContext, c.settingsRepository)
            ...
            modelClass.isAssignableFrom(SettingsViewModel::class.java) ->
                SettingsViewModel(c.settingsRepository, c.notificationScheduler, c.diskCache, c.notifier, c.updateRepository, c.selfCoder, c.usageRepository, c.cerebellumStore, c.profileStore, c.taskStore, c.memoryStream, c.wifiPolicyController)
