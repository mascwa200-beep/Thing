...
enum class SettingsCategory(
    ...
    INTERFACE("Interface", "Theme · accessibility · home layout", "UI", Icons.Filled.Palette,
        "appearance colour color accent amoled boot overlay contrast haptics home dashboard"),
    ...
    NOTIFICATIONS("Notifications", "Alerts · check-ins · quiet hours", "NTF", Icons.Filled.Notifications,
        "push breaking emergency market weather safety flight survival tips digest oracle quiet hours world pulse"),
    CONTENT("Content & feeds", "Refresh · watchlist · feeds · mutes", "FEED", Icons.Filled.ViewList,
        "refresh interval wifi articles watchlist crypto rss feed muted keywords image search"),
