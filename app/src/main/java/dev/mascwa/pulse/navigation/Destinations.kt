...
object Routes {
    ...
    const val JARVIS_INTERESTS = "jarvis_interests"
    const val JARVIS_PROJECTS = "jarvis_projects"
...
val TOP_DESTINATIONS = listOf(
    ...
    TopDestination(Routes.JARVIS_MEMORY, "MEMORY", Icons.Filled.Settings, Icons.Outlined.Settings),
)