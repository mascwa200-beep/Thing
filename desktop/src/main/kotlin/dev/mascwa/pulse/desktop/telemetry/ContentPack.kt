// MIRROR OF core/telemetry/src/main/java/dev/mascwa/pulse/core/telemetry/ContentPack.kt — regenerate with tools/mirror_desktop_cores.py; MirrorDriftTest holds it
