 ...
 *
 * [Stardate] itself is now genuinely SHARED — both platforms compile the same file out of
 * `:core:telemetry` — but reading a clock and a time zone is exactly the platform-facing part it keeps
 * out, and the phone's equivalent lives in `app/.../ui/StardateClock.kt`. The arithmetic that matters —
