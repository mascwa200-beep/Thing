// MIRROR OF core/telemetry/src/test/java/dev/mascwa/pulse/core/telemetry/NewsSummaryTest.kt — regenerate with tools/mirror_desktop_cores.py; MirrorDriftTest holds it
